...
export SIRMIONE_ALIAS=rd0108
export LIMONE_ALIAS=rd0108
export SCORPIO_ALIAS=rd0108
export VIRGO_ALIAS=rd0108
export LIBRA_ALIAS=rd0108
export ZODIAC_ALIAS=rd0108
